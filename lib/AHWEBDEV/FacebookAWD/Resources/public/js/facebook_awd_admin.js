...
function AWDFacebookAdmin($) {
    ...
    this.bindEvents = function()
    {
        ...
        $awd.dependListener('#awd_fcbk_option_likebutton_on_pages', '.depend_likebutton_on_pages', ['1']);
        $awd.dependListener('#awd_fcbk_option_likebutton_on_posts', '.depend_likebutton_on_posts', ['1']);
        $awd.dependListener('#awd_fcbk_option_likebutton_on_custom_post_types', '.depend_likebutton_on_custom_post_types', ['1']);
        $awd.dependListener('.loginbutton_show_faces', '.depend_loginbutton_show_faces', ['1']);
        $awd.dependListener('.likebutton_type', '.depend_likebutton_type', ['xfbml', 'html5']);
        $awd.dependListener('.commentsbox_place', '.depend_on_commentsbox_place', ['replace']);
        ...
        $('.awd_tooltip').live('click', function(e) {
            e.preventDefault();
        });
        ...
        $('#submit_settings').click(function(e) {
            ...
            $.post(ajaxurl, postData + '&action=' + 'awd_fcbk_save_settings', function(data) {
                $('#AWD_facebook_notices').html(data.notices);
        ...
        $('.getPermissions').live('click', function(e) {
            e.preventDefault();
            var $this = $(this);
        ...
        $('.show_ogp_form').live('click', function(e) {
            ...
            $.post(ajaxurl, 'object_id=' + object_id + '&action=get_opengraph_object_form', function(data) {
        ...
        $('.awd_edit_opengraph_object').live('click', function(e) {
            ...
            $('.awd_ogp_form').slideUp();
            $.post(ajaxurl, 'object_id=' + object_id + '&copy=' + copy + '&action=get_opengraph_object_form', function(data) {
                $('.awd_ogp_form').html(data).slideDown();
                $awd.initToolTip();
                $button.button('reset');
                prettyPrint();
