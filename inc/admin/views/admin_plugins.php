...
<div id="div_options_content">
    ...
    <div id="settings_plugins" class="tabbable tabs-left">
        ...
        <div class="tab-content">
            ...
            <div id="activitybox_settings" class="tab-pane">
                <?php
            ...
            <div id="shared_activitybox_settings" class="tab-pane">
                <?php
                if ($this->options['connect_enable'] == 1) {
                    ...
                    $this->templateManager->displayMessage(__('You must enable FB Connect and set parameters in settings of the plugins', self::PTD), 'error');
                }
                ?>
            </div>
            ...
            <div id="commentsbox_settings" class="tab-pane">
                <?php
                $message = '<i class="icon-warning-sign"></i> ' . __('The form place depend on how your form theme is coded. Maybe some places will not work with your theme.', self::PTD);
