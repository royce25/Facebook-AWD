...
?>
				...
				<table class="table table-condensed">
					...
					<tbody>
						...
						<tr>
							...
							<td class="app_active_users"><?php echo isset($infos['daily_active_users']) ? $infos['daily_active_users'] : 0;
														 ?></td>
						</tr>
						<tr>
							<th><?php _e('Weekly active users', $this->ptd); ?>:</th>
							<td class="app_active_users"><?php echo isset($infos['weekly_active_users']) ? $infos['weekly_active_users'] : 0;
														 ?></td>
						</tr>
						<tr>
							<th><?php _e('Monthly active users', $this->ptd); ?>:</th>
							<td class="app_active_users"><?php echo isset($infos['monthly_active_users']) ? $infos['monthly_active_users'] : 0;
														 ?></td>
						</tr>
					</tbody>
					<tfoot>
						<tr>
							...
							?>
								<td><a href="#" id="reload_app_infos" class="btn btnNormal" data-loading-text="<i class='icon-time'></i> Loading..."><i class="icon-wrench"></i> <?php _e('Test Settings', $this->ptd);
																																												 ?></a></td>
							<?php } else { ?>
								<td></td>
							<?php } ?>
				...
				public function define_ogp_objects()
				{
					...
					if ($object_template != null) {
						if (is_object($post)) {
							...
							if (isset($object_template['auto_load_images_attachment'])) {
								$images = array();
							...
							if (isset($object_template['auto_load_videos_attachment'])) {
								$videos = array();
							...
							if (isset($object_template['auto_load_audios_attachment'])) {
								$audios = array();
 ...
 && !$is_term_to_exclude) {
		...
		<tr>
			...
			<td>
				<input type="text" name="fb_email" id="fb_email" value="<?php echo esc_attr(get_user_meta($user->ID, 'fb_email', true));
																		?>" class="regular-text" /><br />
				<span class="description"><?php _e('Enter your Facebook Email', $this->ptd);
										  ?></span>
			</td>
		</tr>
		<tr>
			...
			<td>
				<input type="text" name="fb_uid" id="fb_uid" value="<?php echo esc_attr(get_user_meta($user->ID, 'fb_uid', true));
																	?>" class="regular-text" /><br />
				<span class="description"><?php _e('Enter your Facebook ID', $this->ptd);
										  ?></span>
			</td>
		</tr>
		<tr>
			<th><label for="fb_reset"><?php _e('Unsync Facebook Account ?', $this->ptd);
									  ?></label></th>
			<td>
				<input type="checkbox" name="fb_reset" id="fb_reset" value="1" /><br />
				<span class="description"><?php _e('Note: This will clear all your facebook data linked with this account.', $this->ptd);
										  ?></span>
			</td>
		</tr>
		</table>
		...
		(function() {
                ...
                e.src = document.location.protocol + '//connect.facebook.net/<?php echo $this->options["locale"];
																			 ?>/all.js';
                <?php
		...
		?>
	 	<div class="AWD_facebook_wrap">
			...
			<div class="row">
				<?php
						echo $form->addSelect(__('Redefine globals settings ?', $this->ptd), 'like_button[redefine]', array(array('value' => 0, 'label' => __('No', $this->ptd)), array('value' => 1, 'label' => __('Yes', $this->ptd))), $options['like_button']['redefine'], 'span3', array('class' => 'span3'));
						echo $form->addSelect(__('Activate ?', $this->ptd), 'like_button[enabled]', array(array('value' => 0, 'label' => __('No', $this->ptd)), array('value' => 1, 'label' => __('Yes', $this->ptd))), $options['like_button']['enabled'], 'span3', array('class' => 'span3'));
						echo $form
								->addSelect(__('Where ?', $this->ptd), 'like_button[place]', array(array('value' => 'top', 'label' => __('Top', $this->ptd)), array('value' => 'bottom', 'label' => __('Bottom', $this->ptd)), array('value' => 'both', 'label' => __('Both', $this->ptd))), $options['like_button']['place'], 'span3', array('class' => 'span3'));
				?>
			</div>
							...
							if ($this->is_user_logged_in_facebook()) {
								if ($this->current_facebook_user_can('publish_stream')) {
									if ($this->current_facebook_user_can('manage_pages')) {
										echo '<div class="row">';
										echo $form
												->addSelect(__('Publish to pages ?', $this->ptd), 'fbpublish[to_pages]', array(array('value' => 0, 'label' => __('No', $this->ptd)), array('value' => 1, 'label' => __('Yes', $this->ptd))), $options['fbpublish']['to_pages'], 'span3', array('class' => 'span3'));
										echo $form
												->addSelect(__('Publish to profile ?', $this->ptd), 'fbpublish[to_profile]', array(array('value' => 0, 'label' => __('No', $this->ptd)), array('value' => 1, 'label' => __('Yes', $this->ptd))), $options['fbpublish']['to_profile'], 'span3', array('class' => 'span3'));
	 	...
	 	<?php
			 ...
			 public function register_AWD_facebook_widgets()
			 {
				 ...
				 $wp_widget_factory->widgets['AWD_facebook_widget_like_button'] = new AWD_facebook_widget(
						 array('id_base' => 'like_button', 'name' => $this->plugin_name . ' ' . __('Like Button', $this->ptd), 'description' => __('Add a Facebook Like Button', $this->ptd), 'model' => $fields['like_button'], 'self_callback' => array($this, 'shortcode_like_button'), 'text_domain' => $this->ptd, 'preview' => true));
				 ...
				 $wp_widget_factory->widgets['AWD_facebook_widget_activity_box'] = new AWD_facebook_widget(
						 array('id_base' => 'activity_box', 'name' => $this->plugin_name . ' ' . __('Activity Box', $this->ptd), 'description' => __('Add a Facebook Activity Box', $this->ptd), 'model' => $fields['activity_box'], 'self_callback' => array($this, 'shortcode_activity_box'), 'text_domain' => $this->ptd, 'preview' => true));
		 ...
		 ?>
			<div class="AWD_facebook_wrap">
				<div class="container-fluid">
					<div class="awd_debug well">
						<div class="page-header"><h2><?php _e('Facebook AWD API', $this->ptd);
													 ?></h2></div>
						<?php $this->Debug($_this['fcbk']); ?>
						
						<div class="page-header"><h2><?php _e('Facebook AWD APPLICATIONS INFOS', $this->ptd);
													 ?></h2></div>
						<?php $this->Debug($_this['options']['app_infos']); ?>
						
						<div class="page-header"><h2><?php _e('Facebook AWD CURRENT USER', $this->ptd);
													 ?></h2></div>
						<?php $this->Debug($_this['me']); ?>
						
						<div class="page-header"><h2><?php _e('Facebook AWD Options', $this->ptd);
													 ?></h2></div>
						<?php $this->Debug($_this['options']); ?>
						
						<div class="page-header"><h2><?php _e('Facebook AWD FULL', $this->ptd);
													 ?></h2></div>
			...
			require_once(dirname(__FILE__) . '/inc/classes/tools/getid3/getid3.php');
