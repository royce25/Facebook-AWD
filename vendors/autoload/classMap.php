...
return array(
    ...
    /*$dependencies = array(
            ...
            'facebook' => dirname(__FILE__) . '/vendors/facebook/facebook.php',
            'AWD_facebook_api' => dirname(__FILE__) . '/Api/AWD_facebook_api.php',
            'AWD_facebook_widgets' => dirname(__FILE__) . '/TemplateManager/AWD_facebook_widget.php',
            'AWD_facebook_template' => dirname(__FILE__) . '/TemplateManager/AWD_facebook_template.php',
            'AWD_facebook_options' => dirname(__FILE__) . '/OptionManager/AWD_facebook_options.php',
            'AWD_facebook_forms' => dirname(__FILE__) . '/TemplateManager/AWD_facebook_form.php',
